...
<body>
  <div class="container">
    ...
    <footer>
      Generated by <strong>Verglos</strong> · <a href="https://verglos.com" style="color:#E85D4C">verglos.com</a>
    </footer>
  </div>
</body>
</html>`;
...
export function generateBadgeMarkdown(score: number): string {
  ...
  return `[![Secured by Verglos](https://img.shields.io/badge/Verglos-${score}-${color}?style=flat-square)](https://verglos.com)`;
}

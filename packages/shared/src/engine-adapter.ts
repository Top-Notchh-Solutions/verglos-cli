...
export interface EngineExecutionRequest { readonly targetSubjectId: string; readonly capabilities: readonly string[]; readonly timeoutMs: number; readonly network: "denied" | "allowlisted"; readonly allowlist?: readonly string[]; readonly signal?: AbortSignal; }

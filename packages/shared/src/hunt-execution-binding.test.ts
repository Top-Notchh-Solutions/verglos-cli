...
test("Hunt execution binding pins recipe, trust, approval, and observation identities", () => {
  const binding = bindHuntExecution({ recipe, trust, approval, ruleId: "d1-1", subjectId, observationId: "urn:uuid:123e4567-e89b-12d3-a456-426614174000", at: "2026-01-01T00:02:00Z" });
...
test("Hunt execution binding refuses widened or unusable approval", () => {
  assert.throws(() => bindHuntExecution({ recipe, trust: { ...trust, signedFeeds: [] }, approval, ruleId: "other-rule", subjectId, observationId: "urn:uuid:123e4567-e89b-12d3-a456-426614174000", at: "2026-01-01T00:02:00Z" }), /exact trusted/);
});

...
const CAPABILITIES: readonly Omit<McpCapability, "action" | "approvalRequired" | "sideEffect" | "networkTargets">[] = [
  { tool: "verglos_check_before_write", plan: "free", maturity: "shipped", inputFields: ["code", "targetPath", "language", "context"], outputFields: ["verdict", "findings", "coverage", "correctedCode", "reasoning", "failure"] },
  ...
  { tool: "verglos_scan", plan: "free", maturity: "shipped", inputFields: ["projectRoot", "limit", "noProvenance", "approvalReceipt"], outputFields: ["projectRoot", "scannedAt", "durationMs", "score", "coverage", "provenance", "findingCount", "findings", "truncated", "headline", "failure"] },
  ...
  { tool: "verglos_policy_check", plan: "free", maturity: "shipped", inputFields: ["manifestPath", "recordStore"], outputFields: ["decision", "subjectId", "policy", "limitations", "reasons", "recordDigest", "coverage", "verification", "failure"] },

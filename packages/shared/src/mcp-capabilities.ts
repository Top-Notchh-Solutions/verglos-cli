...
const CAPABILITIES: readonly Omit<McpCapability, "action" | "approvalRequired" | "sideEffect" | "networkTargets">[] = [
  ...
  { tool: "verglos_check_package", plan: "free", maturity: "shipped", inputFields: ["packageName", "version", "approvalReceipt"], outputFields: ["verdict", "packageName", "version", "exists", "typosquat", "cves", "coverage", "limitations", "reasoning"] },
  { tool: "verglos_scan", plan: "free", maturity: "shipped", inputFields: ["projectRoot", "limit", "noProvenance", "approvalReceipt"], outputFields: ["projectRoot", "scannedAt", "durationMs", "score", "provenance", "findingCount", "findings", "truncated", "headline"] },

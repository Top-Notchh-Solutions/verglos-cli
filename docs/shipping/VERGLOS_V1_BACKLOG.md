...
- [ ] **AGENT-004** · MCP discovery/capability truth · deps: AGENT-003, TRUTH-003 · Advertise only shipped/partial capabilities with plan, permission, inputs, outputs, side effects, and maturity. Commit(s): pending (preparatory)

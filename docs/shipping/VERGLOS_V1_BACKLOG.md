...
- [ ] **ENGINE-004** · safe archive downloader/extractor · deps: ENGINE-003 · Stream with limits; reject checksum/signature mismatch, traversal, symlink/hardlink escape, unexpected members, and partial output. Commit(s): `pending (preparatory)`

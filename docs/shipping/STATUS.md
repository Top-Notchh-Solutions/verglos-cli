...
`POLICY-005`: policy schema, loader, Free/Pro profiles, and local diff command are implemented and tested. Next is baseline contract/store; public evidence commands and engine orchestration remain open.
